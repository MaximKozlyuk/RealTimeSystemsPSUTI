...
// Задача TaskSF должна передавать в качестве сообщения фамилии выполняющих работу.
void taskSF(void *arg) {
    int retval;
    char message[] = "Kozlyuk Bulychev";
...
// TaskRF должна принимать и выводить в консоль принятое сообщение.
...
void startup() {
    ...
    // set timer to tick in nanoseconds and not in jiffies
    rt_timer_set_mode(0);
